...
function AddUsers() {
  ...
  const typesOfUsers = ['Admin', 'Manager', 'User'];
  ...
  const AddUser = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://127.0.0.1:8000/admin_dashboard/add_user/', { username, email, password, role, dob, department});
